...
<section class="space-y-4 lg:space-y-5">
  ...
  >
    ...
    <div class="px-4 py-3 lg:px-5">
      <div class="flex items-center gap-3">
        <span class="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-amber-500/10 text-amber-700">
    ...
    <div class="px-4 py-3 lg:px-5">
      <div class="flex items-center gap-3">
        <span class="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-violet-500/10 text-violet-700">
    ...
    <form
      ...
      class="px-4 py-3 lg:px-5"
    >
      <div class="flex items-center gap-3">
        <span class="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-ink-50 text-ink-700 dark:bg-ink-100">
        ...
        <div class="flex shrink-0 gap-1 rounded-full bg-ink-100 p-1 dark:bg-ink-200">
          <button
            ...
            class="rounded-full px-3 py-1 text-xs font-semibold transition {data.user.theme === 'light'
  ...
  <section
    aria-label="Navigasi cepat ke fitur populer"
    class="mt-4"
  >
