...
<section
  ...
  class="relative py-32 overflow-hidden bg-ink-900 text-white isolate font-sans group"
>
  ...
  <div class="container mx-auto px-6 text-center relative z-10">
    <div class="max-w-4xl mx-auto space-y-8">
      <div
        class="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-900/40 border border-primary-500/40 text-accent-200 rounded-full text-xs font-bold uppercase tracking-widest mb-4 shadow-[0_0_15px_rgba(99,102,241,0.2)]"
      >
        <span class="w-2 h-2 rounded-full bg-accent-400 animate-ping"></span>
        <span class="w-2 h-2 rounded-full bg-accent-400 absolute"></span>
        Gabung 50.000+ reseller se-Indonesia
      </div>
      ...
      <div class="pt-10 flex flex-col md:flex-row items-center justify-center gap-6">
        <a
          href={regBase}
          class="group relative inline-flex items-center justify-center gap-3 bg-accent-500 text-white px-10 py-5 rounded-full font-bold text-xl shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:shadow-[0_0_50px_rgba(6,182,212,0.8)] hover:scale-105 transition-all duration-300 ring-4 ring-accent-500/20 z-20 overflow-hidden"
        >
        ...
        <a href="#cara-kerja" class="text-ink-400 hover:text-white font-medium transition flex items-center gap-2 group/link">
          <span class="group-hover/link:-rotate-180 transition-transform duration-500">↺</span> Saya mau lihat cara kerjanya
        </a>
      </div>

      <div class="mt-16 pt-8 border-t border-white/5 grid grid-cols-2 md:grid-cols-4 gap-8 text-center opacity-70">
        <div>
          <div class="text-3xl font-black text-white mb-1">8.185</div>
          <div class="text-[10px] text-ink-400 uppercase tracking-widest">Layanan</div>
        </div>
        <div>
          <div class="text-3xl font-black text-white mb-1">Rp10rb</div>
          <div class="text-[10px] text-ink-400 uppercase tracking-widest">Min Top Up</div>
        </div>
        <div>
          <div class="text-3xl font-black text-white mb-1">24/7</div>
          <div class="text-[10px] text-ink-400 uppercase tracking-widest">Panel Online</div>
        </div>
        <div>
          <div class="text-3xl font-black text-white mb-1">🔄</div>
          <div class="text-[10px] text-ink-400 uppercase tracking-widest">Garansi Refill</div>
        </div>
      </div>
    </div>
  </div>
